...
- Loading this skill activates the Sublime bridge Pi tools for the session (`sublime_ping`, `sublime_status`, `sublime_list_windows`, `sublime_list_views`, `sublime_scope_debug`, `sublime_run_command`, `sublime_list_output_panels`, `sublime_get_output_panel`, `sublime_get_console_log`).
